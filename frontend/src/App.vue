  ...
  <div id="stratumrace-app">
    <header class="app-header">
      ...
      <nav class="app-nav" :class="{ 'nav-open': mobileNavOpen }">
        ...
        <a href="https://x.com/stratumrace" target="_blank" rel="noopener" class="social-link" aria-label="Follow StratumRace on X" @click="closeMobileNav">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
          </svg>
        </a>
        <a href="https://github.com/proofofmike/stratum-race" target="_blank" rel="noopener" class="social-link" aria-label="View source on GitHub" @click="closeMobileNav">
